"""
NVIDIA-only LLM caller — fail fast if not configured.
...
Configure via env vars:
  ...
  LLM_TIMEOUT_SECONDS=180 (optional)
...
def call_llm(
    ...
    """Call NVIDIA LLM with retry logic. Fail fast if not configured."""
    ...
    model = _e("NVIDIA_MODEL", "meta/llama-3.1-405b-instruct")
